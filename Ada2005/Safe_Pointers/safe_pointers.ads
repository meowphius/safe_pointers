...
package Safe_Pointers is
  ...
  -- tute for the corresponding (pool specific) access types:
  --
  ...
  --  C.G.   3.0  12.02.2009  Ada 2005: private with
  --  C.G.   4.0  27.12.2009  References and Raw count; removed aliasing
  --  C.G.   4.1  13.07.2011  Ada 2012 drops pragma Controlled
  --====================================================================
