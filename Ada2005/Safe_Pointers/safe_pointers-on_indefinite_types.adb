...
package body Safe_Pointers.On_Indefinite_Types is
  ...
  --  C.G.   3.0  12.02.2009  Ada 2005: new function Reference
  --  C.G.   4.0  28.12.2009  Reference via Accessor; removed Alias
  --  C.G.   4.1  30.06.2011  Added generic formal Free
  --====================================================================
  ...
  begin
    Finalize (Pointer);
    Pointer.Track := new Track'(new Object'(Value), References => 1, Raw_Count => 0);
  end Allocate;
